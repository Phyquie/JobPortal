    ...
    return (
        <div className="flex w-full py-3 justify-between px-4 shadow-2xl bg-[#2f2b4e] text-white sticky top-0 z-50">
            <Link href="/" className="flex items-center space-x-2">
                <div className=' text-sm md:text-2xl font-extrabold w-11 md:w-56'>Rojgaar</div>
            </Link>
            ...
            <div className='flex '>
                ...
                <Link href="/createJob" className='flex'>
                    <div className="bg-[#a989f6] hidden    md:flex rounded-2xl font-bold px-3 py-1  items-center  md:w-28">Post a Job</div>
                </Link>
            </div>
